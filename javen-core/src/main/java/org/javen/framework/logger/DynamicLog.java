...
public final class DynamicLog implements Log {

    private final Log delegate;

    DynamicLog(String logClassName, MethodHandle invoker, Object param) throws Throwable {
        this.delegate = createLog(logClassName, invoker, param);
    }

    private Log createLog(String logClassName, MethodHandle invoker, Object param) throws Throwable {
        return switch (logClassName) {
            case "org.slf4j.Logger" -> new Sl4jLog(invoker, param);
            case "org.apache.logging.log4j.Logger" -> new Log4j2Log(invoker, param);
            case "org.apache.commons.logging.Log" -> new CommonLoggingLog(invoker, param);
            default -> throw new IllegalArgumentException("Unknown log name [" + logClassName + "]");
        };
    }
